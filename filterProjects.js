...
const PUBLICATION_SUBTOPICS = new Map([
  ...
  ['EarthVerse: Benchmarking Scientific Agents Across Dynamic Earth Systems and Natural Hazards', ['agent-evaluation', 'ai-science', 'fairness']],
  ['Public Transit Gains and Spatially Uneven Travel Demand Changes after NYC Congestion Pricing', ['spatiotemporal', 'uncertainty', 'calibration']],
  ['Bridge: Retrieval-Augmented Spatiotemporal Modeling for Urban Delivery Demand', ['spatiotemporal']],
  ...
  ['TimePre: Bridging Accuracy, Efficiency, and Stability in Probabilistic Time-Series Forecasting', ['spatiotemporal', 'uncertainty', 'calibration']],
  ['AlphaOPT: Formulating Optimization Programs with Self-Improving LLM Experience Library', ['rsi', 'agent-evaluation']],
  ['From Patchwork to Network: A Comprehensive Framework for Demand Analysis and Fleet Optimization of Urban Air Mobility', ['spatiotemporal']],
  ['Human-guided Urban Form Generation Using Multimodal Diffusion Models', ['multimodal']],
  ['UQGNN: Uncertainty Quantification of Graph Neural Networks for Multivariate Spatiotemporal Prediction', ['spatiotemporal', 'uncertainty']],
  ['Interpretable Time Series Autoregression for Periodicity Quantification', ['spatiotemporal']],
  ['Reliable imputation of incomplete crash data for predicting driver injury severity', ['spatiotemporal', 'uncertainty']],
  ['Dynamic Autoregressive Tensor Factorization for Pattern Discovery of Spatiotemporal Systems', ['spatiotemporal']],
  ['Towards Foundation Model for Spatiotemporal Data Analysis', ['spatiotemporal']],
  ['Reimagining Urban Science: Scaling Causal Inference with Large Language Models', ['ai-science']],
  ['GETS: Ensemble Temperature Scaling for Calibration in Graph Neural Networks', ['uncertainty', 'calibration']],
  ['Time Series Supplier Allocation via Deep Black-Litterman Model', ['spatiotemporal']],
  ['Mitigating Spatial Disparity in Urban Prediction Using Residual-Aware Spatiotemporal Graph Neural Networks: A Chicago Case Study', ['spatiotemporal', 'fairness']],
  ['ItiNera: Integrating Spatial Optimization with Large Language Models for Open-domain Urban Itinerary Planning', ['spatiotemporal']],
  ['Uncertainty-aware Probabilistic Graph Neural Networks for Road-level Traffic Crash Prediction', ['spatiotemporal', 'uncertainty', 'calibration']],
  ['Uncertainty Quantification of Sparse Travel Demand Prediction with Spatial-Temporal Graph Neural Networks', ['spatiotemporal', 'uncertainty', 'calibration']],
  ['Uncertainty Quantification via Spatial-Temporal Tweedie Model for Zero-inflated and Long-tail Travel Demand Prediction', ['spatiotemporal', 'uncertainty']],
  ...
  ['Large Language Models for Travel Behavior Prediction', ['spatiotemporal']],
  ['Inductive Graph Neural Networks for Spatiotemporal Kriging', ['spatiotemporal']],
  ...
  ['Uncertainty Quantification of Spatiotemporal Travel Demand with Probabilistic Graph Neural Networks', ['spatiotemporal', 'uncertainty']],
  ...
  ['Virtual Nodes Improve Long-term Traffic Prediction', ['spatiotemporal']],
  ['Fairness-Enhancing Vehicle Rebalancing in the Ride-hailing System', ['fairness']],
  ['ST-GIN: An Uncertainty Quantification Approach in Traffic Data Imputation with Spatio-temporal Graph Attention and Bidirectional Recurrent United Neural Networks', ['spatiotemporal', 'uncertainty']],
  ['Fairness-enhancing Deep Learning for Ride-hailing Demand Prediction', ['spatiotemporal', 'fairness']],
  ['A Universal Framework of Spatiotemporal Bias Block for Long-term Traffic Forecasting', ['spatiotemporal', 'fairness']],
  ['Low-rank Hankel Tensor Completion for Traffic Speed Estimation', ['spatiotemporal']],
  ['Spatial Aggregation and Temporal Convolution Networks for Real-time Kriging', ['spatiotemporal']],
  ['Advancing Transportation Mode Share Analysis with Built Environment: Deep Hybrid Models with Urban Road Network', ['spatiotemporal']],
  ['Understanding the Bike Sharing Travel Demand and Cycle Lane Network: The Case of Shanghai', ['spatiotemporal']]
]);
